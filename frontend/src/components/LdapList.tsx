        ...
        <table className="w-full border-collapse">
          <thead>
            <tr className="bg-[#1f2937] text-white">
              ...
              <th className="p-3 text-[10px] font-bold uppercase tracking-widest border-r border-gray-700/50 text-left">Flotte</th>
              <th className="p-3 text-[10px] font-bold uppercase tracking-widest text-left min-w-40">Localisation</th>
            </tr>
          </thead>
